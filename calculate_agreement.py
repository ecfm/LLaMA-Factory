...
def calculate_improvement(finetuned_agreement: float, base_agreement: float, explicit_agreement: float) -> Dict[str, float]:
    """Calculate improvement metrics."""
    absolute_improvement = finetuned_agreement - base_agreement
    
    # Calculate relative improvement (as percentage of possible improvement)
    if explicit_agreement > base_agreement:
        headroom = explicit_agreement - base_agreement
    ...
    return {
        ...
        "explicit_vs_base": explicit_agreement - base_agreement
    }
...
def main():
    ...
    print(f"  Explicit instruction agreement: {explicit_agreement:.2f}%")
